...
The program is developed as a **command-line application** and executed using **Google Colab**, as required by the assignment guidelines.
...
Calculate distance from ideal best and ideal worst
...
The program effectively ranks alternatives based on multiple weighted criteria and produces accurate results.
